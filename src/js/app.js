App = {
    ...
    addFarmer: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addFarmer(App.accountID);
        }).then(function(result) {
            $("#ftc-item").text(result);
            console.log('purchaseItem',result);
        }).catch(function(err) {
    ...
    addDistributor: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addDistributor(App.accountID);
        }).then(function(result) {
            $("#ftc-item").text(result);
            console.log('purchaseItem',result);
        }).catch(function(err) {
    ...
    addRetailer: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addRetailer(App.accountID);
        }).then(function(result) {
            $("#ftc-item").text(result);
            console.log('purchaseItem',result);
        }).catch(function(err) {
    ...
    addConsumer: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function(instance) {
            return instance.addConsumer(App.accountID);
        }).then(function(result) {
            $("#ftc-item").text(result);
            console.log('purchaseItem',result);
        }).catch(function(err) {
