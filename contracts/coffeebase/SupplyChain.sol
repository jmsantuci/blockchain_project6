...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole, Ownable {
  ...
  // modifier onlyOwner() {
  //   require(msg.sender == owner, "The sender is not the contract owner");
  //   _;
  // }
  ...
  modifier paidEnough(uint _price) {
    require(msg.value >= _price,  "The paid amount is insufficient");
    _;
  }
  ...
  function buyItem(uint _upc) public payable forSale(_upc) paidEnough(msg.value) checkValue(_upc) onlyDistributor {
